...
// 基于现有 /ip-pm.webp 素材做姿态与交互；更换全身立绘可进一步增强"站立"感。
        ...
        >
          ...
          >
            <div className="flex items-start gap-3.5">
              {/* 站立的人物 + 舞台 */}
              <div className="relative flex h-28 w-24 flex-none items-end justify-center">
                {/* 舞台光/地面 */}
                <div
                  aria-hidden
                  className="absolute bottom-0 left-1/2 h-3 w-16 -translate-x-1/2 rounded-full bg-accent-400/20 blur-[6px]"
                />
                {/* 交互区（点击打招呼/换一句） */}
                <motion.div
                  key={poke}
                ...
                >
                  ...
                  {/* 浮动的主体（说话时更活泼） */}
                  <motion.div
                    className="relative h-24 w-24 flex-none"
